...
class GF_MTA_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'gf-merge-tag-autocomplete';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'gf-merge-tag-autocomplete/gf-merge-tag-autocomplete.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'gf-merge-tag-autocomplete';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'GF Merge Tag Autocomplete';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Type { in any Gravity Forms merge-tag-enabled field to instantly search and insert merge tags — no more clicking the {..} button.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'gf-merge-tag-autocomplete';
     ...
     * @var string
     */
    private const CACHE_KEY = 'gf_mta_github_release';
    ...
    private static function parse_readme(): array
    {
        ...
        for ($i = 1, $count = count($parts); $i < $count; $i++) {
            ...
            if ('installation' === $title) {
                ...
                // Include in description (e.g. "Key Features").
                $description .= "\n\n## " . trim($lines[0]) . "\n" . $body;
            }
        }
